...
//CAMBIO COLOR CONSTANTE DEL TITULO
...
//GENERANDO DULCES ALEATORIAMENTE
...
// FILAS Y COLUMNAS DE LOS DULCES ALEATORIAMENTE
...
//TEMPORIZADOR, CAMBIO DE ASPECTO
function endGame() {
	$('div.panel-tablero, div.time').effect('fold');
	$('h1.main-titulo').addClass('title-over')
		.text('Gracias por jugar...Vuelve pronto');
...
//MOSTRANDO LOS CARAMELOS EN EL TABLERO
function checkBoard() {
	fillBoard();
}
